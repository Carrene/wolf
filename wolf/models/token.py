...
from restfulpy.orm import DeclarativeBase, ModifiedMixin, FilteringMixin, PaginationMixin, Field, DBSession
...
class Token(ModifiedMixin, PaginationMixin, FilteringMixin, DeclarativeBase):
    __tablename__ = 'token'
