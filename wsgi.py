...
def cross_origin_helper_app(environ, start_response):
    def better_start_response(status, headers):
        ...
        headers.append(('Access-Control-Expose-Headers', 'X-Pagination-Count, X-Pagination-Skip, X-Pagination-Take, X-Identity'))
        headers.append(('Access-Control-Allow-Methods', 'LOGIN, LIST, UNLOCK, DEACTIVATE, ACTIVATE, DELETE, EXTEND, GET'))
